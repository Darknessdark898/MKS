...
- pin_list:
  ...
  - {pin_num: '5', peripheral: CTIMER2, signal: 'MATCH, 1', pin_signal: PIO1_6/FC0_TXD_SCL_MISO_WS/SD0_D3/CTIMER2_MAT1/SCT_GPI3, mode: pullDown}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    IOCON->PIO[1][6] = ((IOCON->PIO[1][6] &
                        ...
                        | IOCON_PIO_MODE(PIO1_6_MODE_PULL_DOWN)
